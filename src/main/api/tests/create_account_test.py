...
class TestCreateAccount:
    ...
    def test_create_account_limit(self,api_manager: ApiManager, create_user_request: CreateUserRequest):
        for _ in range(2):
            api_manager.user_steps.create_account(create_user_request)

        api_manager.user_steps.create_account_limit(create_user_request)
